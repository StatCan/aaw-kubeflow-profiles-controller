...
var defaultResources = corev1.ResourceList{
	"requests.cpu": *resource.NewQuantity(36, resource.DecimalSI),

	"limits.cpu": *resource.NewQuantity(45, resource.DecimalSI),

	// Memory
	"requests.memory": *resource.NewScaledQuantity(150, resource.Giga),
